...
#include "FileBrowserDisplay_FileBrowserdisplay.h"  // Generated
#include <Windows.h>
#include <string>
#include <vector>
using namespace std;
...
JNIEXPORT void JNICALL Java_FileBrowserDisplay_FileBrowserdisplay_toFind(JNIEnv *env, jobject thisObj,jstring s) {
    ...
    FindFile(search_dir,env,thisObj);       //Finding Directory
